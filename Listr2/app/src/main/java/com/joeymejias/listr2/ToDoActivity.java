...
public class ToDoActivity extends AppCompatActivity {
    private ToDoAdapter mItemListAdapter;
    private MySingleton mToDoSingleton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToDoSingleton = MySingleton.getInstance();
        ...
        mItemListAdapter = new ToDoAdapter(this,mToDoSingleton.getToDoLists().get(mListIndex).getToDoItems());
    ...
    public void showInputDialog(){
        ...
        final EditText titleEditText = (EditText) dialogView.findViewById(R.id.item_text);
